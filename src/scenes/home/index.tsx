        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            <div className="relative">
              <div className="before:absolute md:before:-top-20 md:before:-left-20 md:before:content-evolvetext md:before:z-[-1]">
            ...
            <p className="mt-8 text-sm">
              ...
              natus ab odit in deserunt nemo delectus ipsam quisquam
              repudiandae, illum sapiente excepturi a harum architecto doloribus
              tenetur error impedit? Rem?
            </p>
          </motion.div>
